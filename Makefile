CC=gcc
RM=rm -frd
CFLAGS=-Wall -Walloc-zero -Walloca -Warith-conversion -Warray-bounds=2 \
    -Wbad-function-cast -Wc++-compat -Wcast-align=strict -Wcast-qual \
    -Wconversion -Wdisabled-optimization -Wdouble-promotion -Wduplicated-cond \
    -Werror -Wextra -Wfatal-errors -Wfloat-equal -Wformat=2 \
    -Wformat-overflow=2 -Wformat-signedness -Wformat-truncation=2 \
    -Wimplicit-fallthrough=5 -Winit-self -Winline -Wlogical-op \
